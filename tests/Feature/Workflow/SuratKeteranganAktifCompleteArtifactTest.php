...
class SuratKeteranganAktifCompleteArtifactTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function test_owner_can_complete_ready_application_with_private_mahasiswa_artifact(): void
    {
        ...
        $this->assertSame(SuratKeteranganAktifApplication::STATUS_COMPLETED, $fresh->status);
     ...
     */
    private function readyApplication($student, array $attributes = []): SuratKeteranganAktifApplication
    {
    ...
    private function assertBlockedApplicationUnchanged(SuratKeteranganAktifApplication $application): void
    {
        $fresh = $application->fresh();
