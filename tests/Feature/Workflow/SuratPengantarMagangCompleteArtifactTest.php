...
class SuratPengantarMagangCompleteArtifactTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function test_owner_can_complete_ready_application_with_private_mahasiswa_artifact(): void
    {
        ...
        $this->assertSame(SuratPengantarMagangApplication::STATUS_COMPLETED, $fresh->status);
     ...
     */
    private function readyApplication($student, array $attributes = []): SuratPengantarMagangApplication
    {
    ...
    {
        $previewGeneration = Mockery::mock(SuratPengantarMagangPreviewGenerationService::class);
        $previewGeneration->shouldNotReceive('generateForCurrentPhase');
        $previewGeneration->shouldNotReceive('generateForPhase');
        $this->app->instance(SuratPengantarMagangPreviewGenerationService::class, $previewGeneration);
    ...
    private function assertBlockedApplicationUnchanged(SuratPengantarMagangApplication $application): void
    {
        $fresh = $application->fresh();
